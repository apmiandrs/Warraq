...
class OCRWorker(QObject):
    ...
    def _preprocess_image(self, img: Image.Image) -> Image.Image:
        ...
        try:
            ...
            # 2. زيادة التباين بشكل معتدل (تجنباً للضجيج الزائد)
            enhancer = ImageEnhance.Contrast(img)
            img = enhancer.enhance(1.5)
            
            # 3. زيادة الوضوح بشكل معتدل
            ...
            # 5. التكبير (مهم جداً للخطوط الصغيرة)
            if img.width < 2000:
    ...
    def _clean_text(self, text: str) -> str:
        ...
        # إزالة الحروف اللاتينية المنفردة أو الكلمات اللاتينية القصيرة جداً التي غالباً ما تكون خطأ قراءة
